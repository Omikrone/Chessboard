...
class MoveGenerator
{
    public:
        ...
        static std::vector<Move> piece_moves(const int square, const Color side, const PieceType& piece_type, const Position& game_state);
        static std::vector<Move> pawn_moves(const int square, const Position& game_state, const Color side, const uint64_t empty_squares, const uint64_t opponent_side);
