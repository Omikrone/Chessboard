...
MoveExecutor::MoveExecutor(GameHistory &history, Position &state,
                           Bitboards &board, Zobrist &zobrist)
...
void MoveExecutor::promotion(const Color side, const int square,
